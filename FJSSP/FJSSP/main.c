 ...
 * @author Anjo
 * @date 2022
 * @brief arvore Binaria Genérica e Lista Ligada Simples
 *
...
int main() {
	...
	aux = InsereMaquinaOperacao(aux, c3, 1);//Insere Maquina na Operacão
	...
	//MostraTodasOperacoes(aux); //Lista Operacoes e mostra as maquinas
	//MostraMaquinasOperacoes(aux,2); // Mostra Maquinas so da Operacão 1
