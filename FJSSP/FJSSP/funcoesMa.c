...
//Cria Maquina
/**
 * @brief Aloca memoria para armazenar a Maquina
 *
 * @param codm - CodMaquina
 * @param tempo - Unidades Tempo maquina
 * @param tipo - Tipo de Maquina
 */
...
/**
 * @brief Aloca memoria para armazenar Nodo de Maquinas
 *
...
/**
 * @brief Procura Maquina pelo seu codigo
 *
 * @param ListaMaquinaa - Lista Maquinas
...
/**
 * @brief Lista na Consola Todas as Maquinas
 *
 * @param ListaMaquinaa - Lista Maquinas
 */
